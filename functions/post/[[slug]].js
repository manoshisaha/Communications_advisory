...
// Serves fully server-rendered blog post pages
// Clean URL: /post/2026-06-01-article-slug
...
export async function onRequest(context) {
  ...
  if (!slug) return Response.redirect(new URL('/blog.html', url.origin).toString(), 302);
  ...
  if (!mdText) {
    return new Response(`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Not Found</title><meta name="robots" content="noindex"></head><body style="font-family:sans-serif;text-align:center;padding:4rem;"><h2>Article not found</h2><a href="/blog.html">← All articles</a></body></html>`,
  ...
  function mdToHtml(md) {
    ...
    h = h.replace(/^---+$/gm,'<hr>');
    h = h.replace(/!\[([^\]]*)\]\(([^)"]+)\)/g,'<figure><img src="$2" alt="$1" style="width:100%;border-radius:8px;"><figcaption>$1</figcaption></figure>');
...
<style>
:root{--red:#c51a1b;--red-dark:#a01415;--blue:#004874;--blue-dark:#003459;--cream:#faf8f5;--warm-gray:#f2efe9;--text-dark:#1a1a1a;--text-mid:#4a4a4a;--text-light:#888;--border:rgba(0,0,0,0.09);--nav-h:72px}
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
body{font-family:'Lato',sans-serif;background:var(--cream);color:var(--text-dark)}
nav{position:fixed;top:0;left:0;right:0;z-index:100;height:var(--nav-h);background:rgba(255,255,255,0.97);backdrop-filter:blur(12px);border-bottom:1px solid var(--border);display:flex;align-items:center}
.nav-inner{max-width:800px;margin:0 auto;padding:0 2rem;width:100%;display:flex;align-items:center;justify-content:space-between}
.nav-logo{font-family:'Cormorant Garamond',serif;font-size:1.1rem;font-weight:700;color:var(--blue);text-decoration:none}
.nav-logo span{color:var(--red)}
.nav-back{font-size:.875rem;color:var(--text-mid);text-decoration:none;font-weight:500}
.nav-back:hover{color:var(--red)}
.post-hero{padding-top:calc(var(--nav-h) + 3rem);background:var(--blue-dark);color:#fff;padding-bottom:3rem}
.post-hero-inner{max-width:800px;margin:0 auto;padding:0 2rem}
.post-category{font-size:.7rem;letter-spacing:.12em;text-transform:uppercase;color:var(--red);font-weight:700;margin-bottom:1rem;display:block}
.post-title{font-family:'Cormorant Garamond',serif;font-size:clamp(1.8rem,4vw,2.75rem);font-weight:700;line-height:1.2;margin-bottom:1.5rem}
.post-meta{font-size:.8125rem;color:rgba(255,255,255,0.55)}
...
.post-body{font-size:1.0625rem;line-height:1.85;color:var(--text-mid);text-align:justify;text-justify:inter-word}
.post-body p{margin-bottom:1.25rem;text-align:justify}
.post-body h2{font-family:'Cormorant Garamond',serif;font-size:1.5rem;font-weight:700;color:var(--blue);margin:2.5rem 0 1rem;padding-bottom:.5rem;border-bottom:1px solid var(--border)}
.post-body h3{font-family:'Cormorant Garamond',serif;font-size:1.2rem;font-weight:600;color:var(--blue);margin:2rem 0 .75rem}
.post-body h4{font-family:'Cormorant Garamond',serif;font-size:1.05rem;font-weight:600;color:var(--blue);margin:1.5rem 0 .5rem}
...
.post-body blockquote{border-left:3px solid var(--red);padding-left:1.5rem;font-family:'Cormorant Garamond',serif;font-size:1.2rem;font-style:italic;color:var(--blue);margin:2rem 0}
.post-body pre{background:var(--warm-gray);border-radius:6px;padding:1.25rem;overflow-x:auto;margin:1.5rem 0;font-size:.875rem;line-height:1.6}
...
.post-cta{background:var(--blue);color:#fff;border-radius:10px;padding:2.5rem;margin-top:3rem;text-align:center}
.post-cta h3{font-family:'Cormorant Garamond',serif;font-size:1.4rem;margin-bottom:.75rem}
.post-cta p{font-size:.9rem;color:rgba(255,255,255,0.7);margin-bottom:1.5rem}
.post-cta a{background:var(--red);color:#fff;text-decoration:none;padding:.75rem 2rem;border-radius:4px;font-weight:700;font-size:.9rem;display:inline-block}
.post-cta a:hover{background:var(--red-dark)}
footer{background:#0d1e2e;color:rgba(255,255,255,0.5);padding:2rem;text-align:center;font-size:.8125rem}
...
<div class="post-hero"><div class="post-hero-inner">
